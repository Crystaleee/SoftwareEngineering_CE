...
public class TextBuddyTest {
	...
	public void testAdd() throws IOException {
		...
		assertEquals("Added to mytextfile.txt: \"item1\"",TextBuddy.doCommand("add item1"));
		//check if the item was actually added into the file
		assertEquals(1, TextBuddy.readFile());
		assertEquals("Added to mytextfile.txt: \"item2\"",TextBuddy.doCommand("+ item2"));
		//check if the item was actually added into the file
		assertEquals(2, TextBuddy.readFile());
		assertEquals("Added to mytextfile.txt: \"item2s\"",TextBuddy.doCommand("+ item2s"));
		//check if the item was actually added into the file
	...
	public void testDelete() throws IOException {
		...
		assertEquals("Deleted from mytextfile.txt: \"item2\"",TextBuddy.doCommand("delete 2"));
		//check if the item was actually added into the file
		assertEquals(2, TextBuddy.readFile());
	}
	...
	public void testDeleteAfterSearch() throws IOException {
		...
		TextBuddy.doCommand("add ite4");
		TextBuddy.doCommand("display");
		assertEquals("Deleted from mytextfile.txt: \"ite4\"",TextBuddy.doCommand("delete 4"));
		TextBuddy.doCommand("display");
		assertEquals("Search done!",TextBuddy.doCommand("search item"));
		assertEquals("Deleted from mytextfile.txt: \"item1\"",TextBuddy.doCommand("delete 1"));
		TextBuddy.doCommand("display");
